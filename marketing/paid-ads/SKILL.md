...
| Retargeting / nurture | Cost per engagement | Meta, Google Display |
| E-commerce sales | ROAS, revenue | Meta Shopping, Google Shopping |

For SaaS: if LTV:CAC > 3:1, the channel is viable. If < 3:1, fix first.
...
- **Phrase "keyword":** Your term in order. Balance of precision and reach.
- **Broad keyword:** Use only with smart bidding and good negative keyword lists.

**Recommended:** Launch with phrase and exact match. Add broad only after phrase match proves ROI.
...
- Lookalike audiences (from customer list or purchase events)
...
**Use LinkedIn when:** ICP is enterprise decision-makers; targeting niche job titles; account-based marketing.

**LinkedIn Lead Gen Forms** pre-populate from LinkedIn profile, increasing conversion 2-5× vs landing page traffic. Keep to 3-4 fields maximum.
...
| "Our click-through rate is high" | CTR without conversion data is a vanity metric. Track cost per qualified lead. |
| "We'll set it and forget it" | Paid ads require weekly optimization. Ignore them and waste compounds. |
