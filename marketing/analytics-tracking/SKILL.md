...
| `aha_moment` | User reaches core value | specific to product |
...
**Last-click:** All credit to the last touchpoint before conversion. Use at MVP stage.
**Data-driven (GA4 default):** Requires 400+ conversions/30 days.
